...
function App() {
  ...
  return (
    <CurrentUserContext.Provider value={currentUser}>
      ...
      <DeleteCardPopup card={acceptDeletePopup.card} isOpen={acceptDeletePopup.isOpen} onClose={handleCloseAllPopups} acceptDelete={handleCardDelete} />
      <ImagePopup card={selectedCard} onClose={handleCloseAllPopups} />
      <ErrorPopup error={error} onClose={handleCloseAllPopups} />
